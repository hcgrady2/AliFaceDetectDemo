package com.example.aliyun_identity_demo.net;
...
public class NormalNetUtils {
    private static final byte[] LOCKER = new byte[0];
    private static NormalNetUtils mInstance;
    private OkHttpClient mOkHttpClient;

    private NormalNetUtils() {
     ...
     * @return
     */
    public static NormalNetUtils getInstance() {
        if (mInstance == null) {
            synchronized (LOCKER) {
                if (mInstance == null) {
                    mInstance = new NormalNetUtils();
                }
            }
        }
        return mInstance;
